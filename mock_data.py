...
# from app.models import db, PricingOption, AvailableDate
...
# pricing_options = [
#     PricingOption(name="Basic Package", description="1-hour photo shoot, 20 edited photos", holdPrice=10.00, price=100.00),
#     PricingOption(name="Standard Package", description="2-hour photo shoot, 30 edited photos", holdPrice=20.00, price=180.00),
#     PricingOption(name="Premium Package", description="4-hour photo shoot, 45 editied photos", holdPrice=30.00, price=320.00),
# ]

# # Sample mock data for available calendar dates
...
# db.session.add_all(available_dates)
# db.session.commit()
...
pricing_options = [
    PricingOption(name="Basic Package", description="1-hour photo shoot, 20 edited photos", holdPrice=10.00, price=100.00),
    PricingOption(name="Standard Package", description="2-hour photo shoot, 30 edited photos", holdPrice=20.00, price=180.00),
    PricingOption(name="Premium Package", description="4-hour photo shoot, 45 edited photos", holdPrice=30.00, price=320.00),
]
